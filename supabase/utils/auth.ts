 ...
 * Sets the user's role ('candidate' or 'company') in the user metadata,
 ...
 * @param userRole - The role to assign to the user ('candidate' or 'company').
 ...
 * @param userRole - The role selected by the user during signup ('candidate' or 'company'). This is passed to the callback.

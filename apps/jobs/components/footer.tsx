...
export function Footer() {
  return (
    <footer className='bg-background border-border'>
      <div className='mx-auto max-w-7xl px-6 pt-8 pb-8 sm:pt-24 lg:px-8 lg:pt-32'>
        <div className='xl:grid xl:grid-cols-3 xl:gap-8'>
          <div className='space-y-8'>
            <div className='flex items-center space-x-2'>
              <div className='h-9 w-9 rounded bg-brand flex items-center justify-center'>
                <span className='text-brand-foreground font-bold text-lg'>S</span>
              </div>
              <span className='font-semibold text-foreground text-xl'>Seeds</span>
            </div>
            <p className='text-sm/6 text-balance text-muted-foreground'>
              Making the world a better place through sustainable growing and planting solutions.
            </p>
        ...
        <div className='mt-16 border-t border-border pt-8 sm:mt-20 lg:mt-24'>
          <p className='text-sm/6 text-muted-foreground'>&copy; 2024 Seeds. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )

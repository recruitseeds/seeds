    ...
    <div className='min-h-screen bg-background'>
        ...
        <div className='container mx-auto px-4 py-8'>
          <div className='flex items-start gap-6'>
            <div className='w-16 h-16 bg-primary/10 rounded-lg flex items-center justify-center'>
              <span className='text-2xl font-bold text-primary'>{mockCompany.name[0]}</span>
            </div>
      ...
      <div className='container mx-auto px-4 py-8'>
        <div className='flex items-center justify-between mb-6'>
          <h2 className='text-2xl font-semibold'>Open Positions ({mockJobs.length})</h2>
              ...
              <div className='flex items-start justify-between'>
                <div className='flex-1'>
                  <div className='flex items-center gap-3 mb-2'>
                    ...
                    <span className='px-2 py-1 bg-primary/10 text-primary text-xs rounded-full'>{job.department}</span>
                  </div>

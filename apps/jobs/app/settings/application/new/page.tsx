...
export default function NewFormTemplatePage() {
  ...
  const [template, setTemplate] = useState<Omit<FormTemplate, 'id' | 'created_at' | 'updated_at'>>({
    name: '',
    description: '',
    category: 'general',
    is_default: false,
  ...
  const handleSave = async () => {
    ...
    const validationErrors = validateFormTemplate(template as FormTemplate)
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Build a custom application form for your jobs</p>
          </div>
        </div>

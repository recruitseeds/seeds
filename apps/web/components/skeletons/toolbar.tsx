    ...
    <div className='sticky top-0 z-40 border-b border-dashed bg-background'>
      <div className='flex items-center'>
        <div className='flex-1 min-w-0 overflow-x-auto'>
          <div className='flex items-center gap-1 p-2 bg-background border-border overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] min-h-[48px]'>

...
import { Blocks, Building2, CalendarClock, CircleHelp, LogOut, MessageCircleQuestion, Settings } from 'lucide-react'
                          ...
                          <SidebarMenuSub>
                            {subItem.subItems.map((childItem) => (
                              <SidebarMenuSubItem key={childItem.title}>
                                <SidebarMenuSubButton asChild isActive={pathname === childItem.url || pathname.startsWith(`${childItem.url}/`)}>

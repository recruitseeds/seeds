...
export const sendInvitationEmail = async (
  ...
  try {
    const { to, inviterName, organizationName, role, acceptUrl, expiresInDays = 7, organizationLogo } = params
...
export const sendBulkInvitationEmails = async (
  ...
  const { invitations, inviterName, organizationName, acceptUrlBase, organizationLogo } = params

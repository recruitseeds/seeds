...
function DialogContent({ className, children, ...props }: DialogContentProps) {
  return (
    <ModalOverlay
      ...
      className={cn(
        // Base overlay styles matching Radix
        'fixed inset-0 z-[100] bg-black/80',
        // Animation classes - React Aria uses different data attributes
    ...
    >
      <Modal
        ...
        {...props}
      >
        <AriaDialog data-slot="dialog-content">
          {children}
...
// Helper component for close buttons in dialog content

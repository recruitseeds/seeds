  ...
  ],
  {
    variants: {
      variant: {
        ...
        'destructive-subtle': [
          'bg-destructive-subtle border border-destructive-border text-destructive-vibrant hover:bg-destructive-subtle/90 active:bg-destructive-subtle/80',
        ],
        outline: [
...
const buttonActiveVariants = cva('', {
  variants: {
    variant: {
      ...
      'destructive-subtle': ['bg-destructive-subtle/80 text-destructive-vibrant', 'border border-destructive-border'],

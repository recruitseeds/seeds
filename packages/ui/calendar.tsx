...
function Calendar({
  ...
  const buttonRangeClassName =
    'bg-accent [&>button]:bg-brand [&>button]:text-white [&>button]:hover:bg-brand [&>button]:hover:text-white'
  ...
  const _selectedClassName = cn(
    '[&>button]:bg-brand [&>button]:text-white [&>button]:hover:bg-brand-hover [&>button]:active:bg-brand-active [&>button]:hover:text-white',
          ...
          <Button
            ...
            className={cn(
              ...
              year === new Date().getFullYear() &&
                'bg-brand font-medium text-brand-foreground hover:bg-brand-hover hover:text-brand-foreground active:bg-brand-active active:text-brand-foreground'
            )}
            variant='ghost'
            onClick={() => {
              setNavView('days')
